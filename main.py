...
def generate_visualizations(file_path='articles.txt'):
    ...
    stop_words = set(['the', 'in', 'to', 'and', 'of', 'a', 'is', 'it', 'has', 'into', 'for', 'with', 'on', 'as', 'that', 'are', 'by', 'this', 'be', 'from', 's', 'at', 'more', 'how', 'what', 'when', 'who', 'why','was','were','but','an','their','them','after','before','about','BBC','bbc'])
...
OPENAI_API_KEY = "INSERT-YOUR-API-KEY-HERE"  # Replace with your actual OpenAI API key
